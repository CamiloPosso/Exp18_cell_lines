...
for (DB in DBs){
  ...
  openxlsx::write.xlsx(combined, paste0("GSEA_states_combined_vs_parental_", DB, ".xlsx"))
  synapseStore(paste0("GSEA_states_combined_vs_parental_", DB, ".xlsx"), "syn51118887")
}
...
xx <- read.table("KSEA_NetworKIN_5_combined.txt", sep = "\t") %>% 
  mutate(contrast = gsub("Treatment_cs", "", contrast),
         contrast = sub("-none", " vs Parental", contrast))
openxlsx::write.xlsx(xx, file = "KSEA_states_combined_vs_parental_PSP_NetworKIN5.xlsx")
synapseStore("KSEA_states_combined_vs_parental_PSP_NetworKIN5.xlsx", "syn51118887")
