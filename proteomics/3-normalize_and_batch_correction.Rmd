...
plot_pca(m_global, phenotype = "SampleID") + ggtitle("Global PCA - All features by Plex")

plot_pca(m_global_with_mouse, phenotype = "Plex") + ggtitle("Global PCA with Mouse - All features by Plex")
plot_pca(m_global_with_mouse, phenotype = "SampleID") + ggtitle("Global PCA with Mouse - All features by Plex")
...
plot_pca(m_global_with_mouse_corrected, phenotype = "SampleID") + ggtitle("Global PCA with Mouse - All features by Plex, Corrected")
...
write.table(exprs(m_global_with_mouse_corrected), 
            file = "data/global_with_mouse_data/Chr8_crosstab_global_gene_corrected.txt",
            quote=F, sep="\t")
