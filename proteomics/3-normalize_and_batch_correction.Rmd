...
meta <- read_excel("../proteomics/data/Experiment 21 - Patient Samples_F.xlsx", sheet = 2) %>%
  filter(!is.na(Tube)) %>%
...
write.table(exprs(m_global_corrected), 
            file = "data/global_data/ptrc_ex21_crosstab_global_gene_corrected.txt",
            quote=F, sep="\t")

write.table(exprs(m_phospho_corrected), 
            file = "data/phospho_data/ptrc_ex21_crosstab_phospho_SiteID_corrected.txt",
            quote=F, sep="\t")
