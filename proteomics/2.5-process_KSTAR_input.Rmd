...
data_package_num <- 5232
data_folder <- "data/phospho_data"
crosstab_prefix <- "ptrc_ex22"

## Use protein level
path_to_global_crosstab <- "data/global_data/ptrc_ex22_crosstab_global_prot_original.txt"
...
# assign("fst_dms_path", temp_filepath, envir = globalenv())
